...
<section class="editable-row">
    ...
    <div class="first-column">
        ...
        <input type='text' required="required" name='content[name]' size="30" id='name' value='<?php echo $content->name; ?>' />

        <label class="icon edit-icon" for='description'><?php if($content->type == "article") echo "Uvodno besedilo"; else echo "Opis"; ?><span class="required">*</span></label>
        <textarea name='content[description]' required="required" style="width:60%; min-height:50px; border-color:#777;" id='description'><?php echo $content->description; ?></textarea><br/>

        <label class="icon edit-icon" for='text'>Besedilo<span class="required">*</span></label>
        <textarea class="editor" name='content[text]' required="required" style="width:100%; min-height:150px;" id='text'><?php echo $content->text; ?></textarea><br/>

        <input type="hidden" id="asoc_id" name='content[id]' value='<?php echo $content->id; ?>'>
        <input type="hidden" name='content[ref_id]' value='<?php echo $content->ref_id; ?>'>
    ...
    <div class="second-column">
        ...
        <div style="overflow: hidden; width:100%; max-width:500px; height: 333px; border:thin dashed #999; border-radius: 5px; background-color:white;">
            <a href="<?php echo base_url().$content->image->extra_large."?img=".rand(0,1000); ?>" class="info fancybox" rel="content-images" title="<?php echo $content->image->name; ?>">
                <img class="attachment-image" src='<?php echo base_url().$content->image->large."?img=".rand(0,1000); ?>' id="image-<?php echo $content->image->id; ?>" alt='attachment image' style="min-height: 333px; margin-left: auto; margin-right: auto; border-radius: 5px; ">
            </a>
        </div>

        <div>
            <hr>
            <input type="hidden" value="<?php echo $content->image->ref_id; ?>" name="image_ref_id">
            <input type="hidden" value="<?php echo $content->image->id; ?>" name="image_id">
            <input type="hidden" value="<?php echo $content->image->url; ?>" name="image_url">
            ...
            <div>
                ...
                <input type="hidden" name='id' class="current-content-id" value="<?php echo $content->image->id; ?>">
                <input type="hidden" name='ref_id' value="<?php echo $content->image->ref_id; ?>">
                <input type="hidden" name='category' value="<?php echo $content->image->category; ?>">
                <input type="hidden" name='url' value="<?php echo $content->image->url; ?>">
...
<section class="editable-row">
    ...
    <div class="first-column">
        ...
        <input type='text' required="required" name='content[author_name]' id='author_name' value='<?php echo $content->author_name; ?>' />

        <label class="icon eye-icon" for='publish_up'>Objava od<span class="required">*</span></label>
        <input class="datepicker_up" required="required" type='text' name='content[publish_up]' id='publish_up' value='<?php echo $content->publish_up; ?>' />

        <label class="icon eye-blocked-icon" for='publish_down'>Objava do</label>
        <input class="datepicker_down" type='text' name='content[publish_down]' id='publish_down' value='<?php echo $content->publish_down; ?>' />

        <label class="icon tags-icon" for='article_tags'>Ključne besede<span class="required">*</span></label>
        <textarea class="tags" required="required" id="article_tags" style="width:95%; min-height:60px; font-size:1.2em; opacity:0.9;" name='content[tags]'><?php echo implode(", ",$content->tags); ?></textarea><br>
